...
public class ConsultaProductos extends JFrame {
    ...
    public ConsultaProductos() {
        setResizable(false);
        setTitle("Consulta para productos.");
        ...
        btnNewButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                try {
                    ...
                    ResultSet registro = comando.executeQuery("select * from productos");
        ...
        btnNewButton.setBounds(10, 410, 128, 23);
        contentPane.add(btnNewButton);

        JButton btnNewButton_1 = new JButton("Volver...");
        btnNewButton_1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                Menu menu_productos = new Menu();
                dispose();
        ...
        btnNewButton_1.setBounds(495, 410, 128, 23);
        ...
        lblNewLabel_2.setBounds(0, 0, 644, 451);
